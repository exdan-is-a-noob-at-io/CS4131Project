...
class ImagePickerActivity : AppCompatActivity() {
    ...
    private fun cropImage(sourceUri: Uri?) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.grey_10))
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.grey_10))
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.grey_10))
